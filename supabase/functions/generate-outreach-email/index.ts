...
Also state, in one short sentence, that the attached letter is the legally correct version, but translations can be found at https://globalartistregistry.org/invitation, where members can download the invitation in English, German, French, Spanish, Italian and Polish (the English version is the authoritative one).
