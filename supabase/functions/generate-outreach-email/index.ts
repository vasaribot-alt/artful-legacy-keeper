...
Make a single, concrete support ask: invite the collection to back the Foundation with a contribution of 5 euros per contemporary work in their collection as a guideline, which directly funds permanent archival preservation for artists. For larger collections, explain that rather than counting every work they can choose the recognition level that fits, with supporters listed on the Foundation's public supporters page at four levels: Bronze 1,000 euros, Silver 2,500 euros, Gold 5,000 euros, Platinum 10,000 euros and above. Frame this as a small, proportional way for a holding collection to secure the long-term record of the very artists whose work it holds. Offer, as a low-pressure alternative, an institutional endorsement or a small joint pilot documenting part of their collection to archival standard. State plainly that registration is free for life for ID-verified artists and that the artist, not GARF, owns the archive. Do not include a bank account number or payment instructions in the email; direct any giving to the linked Why GARF Matters page and the /donate page.
...
Also state, in one short sentence, that the attached letter is the legally correct version, but translations can be found at https://globalartistregistry.org/invitation, where members can download the invitation in English, German, French, Spanish, Italian and Polish (the English version is the authoritative one). Add one further short sentence saying the attached PDF itself carries a footer with that link, so members who read English with difficulty find their own language, and that the same page offers a ready-to-paste announcement text in all six languages for the organisation's newsletter or members' area.
Include a short, clearly marked section headed "What we are asking — and what we are not asking" with these points, kept close to this wording:
