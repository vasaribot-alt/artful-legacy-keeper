...
import { SceneTitleDuplicate } from "./scenes/SceneTitleDuplicate";
import { SceneDuplicateHover } from "./scenes/SceneDuplicateHover";
import { SceneDuplicateDialog } from "./scenes/SceneDuplicateDialog";
import { SceneTakePhoto } from "./scenes/SceneTakePhoto";
import { SceneDuplicateSaved } from "./scenes/SceneDuplicateSaved";
  ...
  return (
    <AbsoluteFill style={{ pointerEvents: "none" }}>
      ...
      <div style={{
        ...
        <span>Duplicate then Capture</span>
      </div>
    </AbsoluteFill>
  );
};

export const HowToDuplicate: React.FC = () => {
  return (
    <AbsoluteFill>
      <PaperGrain />
      <SafeArea>
        <TransitionSeries>
          <TransitionSeries.Sequence durationInFrames={170}><SceneTitleDuplicate /></TransitionSeries.Sequence>
          <TransitionSeries.Transition presentation={fade()} timing={springTiming({ config: { damping: 200 }, durationInFrames: 22 })} />
          <TransitionSeries.Sequence durationInFrames={200}><SceneDuplicateHover /></TransitionSeries.Sequence>
          ...
          <TransitionSeries.Sequence durationInFrames={230}><SceneDuplicateDialog /></TransitionSeries.Sequence>
          <TransitionSeries.Transition presentation={fade()} timing={springTiming({ config: { damping: 200 }, durationInFrames: 22 })} />
          <TransitionSeries.Sequence durationInFrames={240}><SceneTakePhoto /></TransitionSeries.Sequence>
          <TransitionSeries.Transition presentation={wipe({ direction: "from-right" })} timing={springTiming({ config: { damping: 200 }, durationInFrames: 26 })} />
          <TransitionSeries.Sequence durationInFrames={200}><SceneDuplicateSaved /></TransitionSeries.Sequence>
        </TransitionSeries>
        <Chrome />
      </SafeArea>
    </AbsoluteFill>
