...
const ITEMS = [
  { cover: "images/cover-1.jpg", title: "Vapor",                              authors: "Hanne De Wachter, Stefan Brüggemann", pub: "Galerie Eigen + Art, Berlin",  year: 2026, isbn: "978-3-86335-512-9", lang: "English / Deutsch",  pages: 184 },
  { cover: "images/cover-2.jpg", title: "With an Essay by Hanne De Wachter",  authors: "Hanne De Wachter",                    pub: "Museum Folkwang, Essen",        year: 2024, isbn: "978-3-7757-5210-3", lang: "English / Deutsch",  pages: 96  },
  { cover: "images/cover-3.jpg", title: "Marie Lefèvre / Elin Vandermeer",    authors: "Marie Lefèvre",                       pub: "Centre Pompidou, Paris",        year: 2022, isbn: "978-2-84426-918-4", lang: "English / Français", pages: 128 },
];
            ...
            return (
              <div key={it.title} style={{
                ...
                <div style={{
                  ...
                  <Img src={staticFile(it.cover)} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                </div>
