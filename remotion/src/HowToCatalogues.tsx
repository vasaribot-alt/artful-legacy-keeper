...
import { SceneTitleCatalogues } from "./scenes/SceneTitleCatalogues";
import { SceneCatalogueNew } from "./scenes/SceneCatalogueNew";
import { SceneCatalogueCover } from "./scenes/SceneCatalogueCover";
import { SceneCatalogueLibrary } from "./scenes/SceneCatalogueLibrary";
import { SceneCatalogueLink } from "./scenes/SceneCatalogueLink";
...
export const HowToCatalogues: React.FC = () => {
  return (
    <AbsoluteFill>
      <PaperGrain />
      <TransitionSeries>
        <TransitionSeries.Sequence durationInFrames={170}><SceneTitleCatalogues /></TransitionSeries.Sequence>
        <TransitionSeries.Transition presentation={fade()} timing={springTiming({ config: { damping: 200 }, durationInFrames: 22 })} />
        <TransitionSeries.Sequence durationInFrames={330}><SceneCatalogueNew /></TransitionSeries.Sequence>
        ...
        <TransitionSeries.Sequence durationInFrames={200}><SceneCatalogueCover /></TransitionSeries.Sequence>
        <TransitionSeries.Transition presentation={fade()} timing={springTiming({ config: { damping: 200 }, durationInFrames: 22 })} />
        <TransitionSeries.Sequence durationInFrames={250}><SceneCatalogueLibrary /></TransitionSeries.Sequence>
        <TransitionSeries.Transition presentation={wipe({ direction: "from-right" })} timing={springTiming({ config: { damping: 200 }, durationInFrames: 26 })} />
        <TransitionSeries.Sequence durationInFrames={260}><SceneCatalogueLink /></TransitionSeries.Sequence>
      </TransitionSeries>
      <Chrome />
    </AbsoluteFill>
  );
