...
import { SceneUploadPreview } from "./scenes/SceneUploadPreview";
import { SceneImagesMatch } from "./scenes/SceneImagesMatch";
import { SceneCatalogueGrid } from "./scenes/SceneCatalogueGrid";
  ...
  return (
    <AbsoluteFill style={{ pointerEvents: "none" }}>
      ...
      <div style={{
        ...
        <span>Bulk import artworks</span>
      </div>
    </AbsoluteFill>
  );
};

export const HowToBulk: React.FC = () => {
  return (
    <AbsoluteFill>
      <PaperGrain />
      <TransitionSeries>
